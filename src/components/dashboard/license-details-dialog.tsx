      ...
      <DialogContent className="bg-zinc-900 border-zinc-800 sm:max-w-lg">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {/* Show Trial badge OR payment status, not both */}
            {license.is_trial ? (
              ...
              <div className="space-y-3">
                ...
                <div className="pl-6 grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className={`text-sm font-semibold ${license.payment_method === 'credits' ? 'text-amber-400' : 'text-green-400'}`}>
                      {license.payment_method === 'credits'
                        ? `${license.payment_amount} credits`
                        : `${license.payment_amount}`}
                    </p>
                  </div>
                  <div>
