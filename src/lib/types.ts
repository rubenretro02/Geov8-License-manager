...
export interface Profile {
  ...
  // Credit system
  credits: number
  credit_price: number // Custom price per credit for this admin (set by super_admin)
...
export interface License {
  ...
  // Auto renewal
  auto_renew: boolean
  auto_renew_days: number // Days to renew for (default 30)
...
export type OrderStatus = 'pending' | 'waiting' | 'confirming' | 'confirmed' | 'sending' | 'partially_paid' | 'finished' | 'failed' | 'refunded' | 'expired'
