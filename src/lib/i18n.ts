export const translations = {
  en: {
    ...
    teamLicensesColumn: 'Team licenses',
    teamSharingEnabled: 'User can now view team licenses',
    teamSharingDisabled: 'User can no longer view team licenses',
  ...
  es: {
    ...
    teamLicensesColumn: 'Licencias del equipo',
    teamSharingEnabled: 'El usuario ya puede ver las licencias del equipo',
    teamSharingDisabled: 'El usuario ya no puede ver las licencias del equipo',
