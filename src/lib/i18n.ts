export const translations = {
  en: {
    ...
    teamSharingTitle: 'Share licenses with team',
    teamSharingDescription: 'Let your users view all licenses created by the team, not just their own',
    teamSharingEnabled: 'Team license sharing enabled',
    teamSharingDisabled: 'Team license sharing disabled',
  ...
  es: {
    ...
    teamSharingTitle: 'Compartir licencias con el equipo',
    teamSharingDescription: 'Permite que tus usuarios vean todas las licencias creadas por el equipo, no solo las suyas',
    teamSharingEnabled: 'Compartir licencias del equipo activado',
    teamSharingDisabled: 'Compartir licencias del equipo desactivado',
